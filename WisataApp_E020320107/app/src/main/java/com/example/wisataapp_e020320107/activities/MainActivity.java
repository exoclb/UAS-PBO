...
import com.example.wisataapp_e020320107.MainAdapter;
import com.example.wisataapp_e020320107.R;
import com.example.wisataapp_e020320107.decoration.LayoutMarginDecoration;
import com.example.wisataapp_e020320107.model.ModelMain;
import com.example.wisataapp_e020320107.utils.Tools;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    List<ModelMain> lsMainMenu = new ArrayList<ModelMain>();
    TextView tvToday;
    String hariIni;
    ...
    private <MainAdapter> void setMenu() {
